...
//go:generate go run ./generation/generate/wrap.go ../../../contracts/solc/v0.8/BatchVRFCoordinatorV2.abi ../../../contracts/solc/v0.8/BatchVRFCoordinatorV2.bin BatchVRFCoordinatorV2 batch_vrf_coordinator_v2
